...
<div style="display:flex;align-items:stretch;background:#0e1020;border-radius:12px;overflow:hidden;margin:2.5rem 0;min-height:260px;">
  <div style="flex:1;padding:2rem 2.25rem;display:flex;flex-direction:column;justify-content:center;">
    ...
    <div style="display:flex;flex-direction:column;gap:0.45rem;margin-bottom:1.4rem;">
    ...
    <a href="https://calendly.com/noeldcosta/30min" style="display:inline-block;background:#fc985a;color:#0e1020;font-weight:700;font-size:0.82rem;padding:0.6rem 1.3rem;border-radius:6px;text-decoration:none;align-self:flex-start;">Book a 30-min call &#8594;</a>
  </div>
  <div style="width:220px;flex-shrink:0;background-image:url('/images/image-1777451570300.jpg');background-size:cover;background-position:top center;"></div>
</div>
