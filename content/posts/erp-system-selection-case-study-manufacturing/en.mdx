---
title: "ERP System Selection for a Mid-Sized Manufacturer in Asia"
...
After two decades in ERP and AI advisory, I thought I had seen it all, until a mid-size [manufacturing company in Poland](https://noeldcosta.com/sap-implementation/for-manufacturing/) nearly signed off on the wrong [ERP system selection](https://noeldcosta.com/build-a-winning-sap-business-case-template-implementation-guide/) that would have cost them an extra $1.2 million. Leadership was overwhelmed by vendor sales talk, the internal politics, and a stack of “must-haves” that looked more like a wish list than real requirements.

That’s when I stepped in. I simplified the ERP selection process, introduced structured [evaluation criteria](https://noeldcosta.com/project-planning-and-control-get-sap-projects-back-on-track/), brought in the right stakeholders, asked them their pain points, and reminded them that ERP selection isn’t a contest, it’s a governance and risk management decision.

We moved beyond demo theatrics and focused on board-level alignment, cost control, and transparency. Tools like a [risk assessment matrix](https://noeldcosta.com/sap-project-risk-assessment-matrix-and-mitigation-strategies/) and project planning frameworks gave leadership the clarity they were missing.
...
![Noel DCosta ERP AI Implementation](/images/wp/elementor/thumbs/Noel-DCosta-ERP-AI-Implementation-racbq8g804ocv8hptqkcebgs8axlga36kaocrl17xs.webp "Noel DCosta ERP AI Implementation")

The client was a medium size [manufacturing company](https://noeldcosta.com/sap-implementation/for-manufacturing/) based in Poland with revenues just under $400 million. They had expanded quickly, but the ERP systems had not kept pace. 
...
-   **Leadership**: CIO pushing for cloud capability, CFO pushing hard on [cost control](https://noeldcosta.com/sap-implementation-cost-breakdown-why-budgets-explode-50/), and COO insisting that operational stability came first.
    
-   **Vendors**: Aggressive tactics, quarter-end discounts, and so-called limited time deals, which made proper [vendor evaluation](https://noeldcosta.com/sap-license-negotiation-10-key-points-to-consider-in-2024/) even harder.
...
My role was to reduce that noise. I applied structured [ERP system selection steps](https://noeldcosta.com/start-your-sap-implementation-project-right/) and a practical [risk assessment process](https://noeldcosta.com/sap-project-risk-assessment-matrix-and-mitigation-strategies/). These gave the leadership team clearer facts to work with. It was not always smooth, but it gave them confidence to decide with governance and long-term resilience in mind.
...
The COO wanted operational stability and believed disruption could harm production. Each of these priorities made sense on its own, but together they created a standstill. Perhaps this is common in [ERP system selection](https://noeldcosta.com/build-a-winning-sap-business-case-template-implementation-guide/), yet the intensity felt sharper in this case.

On top of that, no one had hard data. There were only polished vendor slide decks with big promises. The company had no detailed model for total cost of ownership. I think this gap is one of the main reasons why many projects collapse during [ERP implementation](https://noeldcosta.com/sap-implementation/).
...
To break the cycle, I slowed the process. I applied structured [evaluation criteria](https://noeldcosta.com/project-planning-and-control-get-sap-projects-back-on-track/) and a practical [risk assessment approach](https://noeldcosta.com/sap-project-risk-assessment-matrix-and-mitigation-strategies/). Perhaps it was not a perfect solution, but it was enough to help the leadership team step back from the noise. They began to see the facts more clearly, and that was when progress started to happen.

## Why did this Mid-Sized Manufacturer Bring Me In

![Does-Your-ERP-help-you-in-your-Business](/images/wp/elementor/thumbs/Does-Your-ERP-help-you-in-your-Business-1-fotor-20250619151138-rac0jfo1az9vmvkww4isegos12a3xo02umgpunyrr4.webp "Does-Your-ERP-help-you-in-your-Business")
...
They needed something different. They wanted someone who could take technical details and translate them into clear boardroom language. I have done this many times, and I think it is often the missing link in [ERP system selection](https://noeldcosta.com/build-a-winning-sap-business-case-template-implementation-guide/).

They also needed someone to push back against vendor pressure. Sales teams were using quarter-end deadlines, special offers, and fear-based tactics to drive decisions. Neutralizing those tactics is part of the work, and in my view it is as important as building [project planning discipline](https://noeldcosta.com/project-planning-and-control-get-sap-projects-back-on-track/).

Finally, they wanted experience. Someone who had seen [ERP failures](https://noeldcosta.com/the-50-billion-erp-failure-why-cfos-still-reach-for-excel-instead/) and could spot red flags early, before they became expensive problems.
...
ERP selection also needs to be treated as a board-level business transformation, not just an IT project. The decision impacts [finance](https://noeldcosta.com/case-study-finance-process-modernization/), supply chain, operations, and even the future cost of ownership. 
...
](https://noeldcosta.com/sap-manufacturing-industry-secrets/)[ERP Comparison
...
](https://noeldcosta.com/best-erp-for-manufacturing/)[Production Planning
...
](https://noeldcosta.com/sap-pp-production-planning/)[Manufacturing ERP
